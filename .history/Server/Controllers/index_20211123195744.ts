...
{
    res.render('indexTwo', { title: 'Create Account', page: 'defaultHome' , displayName: ''});
}
            ...
            if (err) {
             ...
             deferred.reject(err);
              ...
              deferred.resolve({
                  ...
                  province: province
                  city: city
                  respond: res.render('index', { title: 'Trainer Page', page: 'trainerHome' ,city: city,province: province,age: age,sex: sex,hourlyRate: hourlyRate, aboutMe: aboutMe, emailAddress: emailAddress,displayNameFromQuery: displayName,phoneNumber: phoneNumber,username: trainerName, displayName: UserDisplayName(req)  });
             }); // return all names
