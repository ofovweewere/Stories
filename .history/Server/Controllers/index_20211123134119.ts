...
export function DisplayTrainerHome(req: Request, res: Response, next: NextFunction): void
{
    ...
    let trainerName = req.params.username;
        ...
        function(err, docs) {
            ...
            */
             res.render('index', { title: 'Trainer Page', page: 'trainerHome' ,city: city,province: province,birthDate: birthDate,sex: sex,hourlyRate: hourlyRate, aboutMe: aboutMe, emailAddress: emailAddress,displayName: displayName,phoneNumber: phoneNumber,username: trainerName, displayName: UserDisplayName(req)  });
