            ...
            if (err) {
             ...
             deferred.reject(err);
              ...
              docs.forEach (function fn(doc) {
                ...
                sex = `${doc.sex}`;
                birthDate = calculate_age(`${doc.birthDate}`);
              ...
              deferred.resolve({
                  ...
                  province: province
                  city: city
                  respond: res.render('index', { title: 'Trainer Page', page: 'trainerHome' ,city: city,province: province,age: calculate_age(birthDate),sex: sex,hourlyRate: hourlyRate, aboutMe: aboutMe, emailAddress: emailAddress,displayNameFromQuery: displayName,phoneNumber: phoneNumber,username: trainerName, displayName: UserDisplayName(req)  });
             }); // return all names
