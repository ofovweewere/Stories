    ...
    function(err, docs) {
        if (err) {
         ...
         deferred.reject(err);
          ...
          var names = [{title: 'dapo',description:'hey'}];
          
          docs.forEach (function(doc) {
            //var item = '{'+ 'title:' +doc.displayName +','+ 'description:'+doc.aboutMe+'}';
            //item.title =doc.displayName;
            //item.description = doc.aboutMe;
            //var item = {title: 'dapo',description:'hey'};
            var item = new Object;
             item.title='dapo';
         ...
         */
        //res.json(names);
        res.render('index', { title: 'Search Results', page: 'searchResult', name: names, displayName: AuditorDisplayName(req)  });
        }
     });
}
