...
import { DisplayHomePage, DisplayRegisterSeekerPage,DisplayRegisterTrainerPage, ProcessRegisterSeekerPage } from '../Controllers/index';
...
router.post('/registerSeeker', ProcessRegisterTrainerPage);
