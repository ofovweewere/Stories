...
import {ProcessSeekerSearchPage,DisplaySeekerSearch,DisplaySeekerHome, DisplayHomePage, DisplayRegisterSeekerPage,DisplayRegisterTrainerPage,DisplayRegisterAuditorPage, ProcessRegisterSeekerPage,ProcessRegisterTrainerPage,ProcessRegisterAuditorPage,ProcessLogoutPage } from '../Controllers/index';
...
/* GET - Display trainer page - with /registerTrainer. */
router.get('/displayTrainerHome', DisplayTrainerHome);
/* GET - Display seeker page - with /registerTrainer. */
